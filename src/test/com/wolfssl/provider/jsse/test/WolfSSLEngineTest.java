...
//        String[] c = server.getSupportedCipherSuites();
...
//        System.out.println("");
        ...
        while (!done) {
            try {
                ...
                System.out.println("ToSend remaning = " + toSend.remaining());
                cliToSer.flip();
                serToCli.flip();
                ...
                if (toSend.remaining() == 0) {
                    ...
                    serPlain.get(b);
                    System.out.println("server recieved : " + new String(b, StandardCharsets.UTF_8));
                    done = true;
                }
